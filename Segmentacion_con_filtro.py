...
# =============================================================================
# ENTRENAMIENTO DE LA SEGUNDA RED POR REGIONES
# =============================================================================
# ruta = r"C:\Users\saul-\OneDrive\IPN\Sem 9\Amebas\ART_48H\ART_66.jpg"

# img_rgb = plt.imread(ruta)

# # Ruta de la imagen

# # 1. Obtener la imagen gris y la máscara calculada
# imagen_original_gris, mascara_ameba = procesar_ameba(ruta, fc_2=80)

# # 2. Crear la imagen superpuesta (Verde con 40% de opacidad por defecto)
# imagen_superpuesta = superponer_mascara(imagen_original_gris, mascara_ameba)

# # 3. Visualización de los 3 pasos
# plt.figure(figsize=(15, 5))

# # Subplot 1: Original
# plt.subplot(1, 3, 1)
# plt.imshow(imagen_original_gris, cmap="gray")
# plt.title("1. Imagen Original (Gris)")
# plt.axis("off")

# # Subplot 2: Máscara sola
# plt.subplot(1, 3, 2)
# plt.imshow(mascara_ameba, cmap="gray")
# plt.title("2. Máscara Binaria Resultante")
# plt.axis("off")

# # Subplot 3: Superposición
# plt.subplot(1, 3, 3)
# plt.imshow(imagen_superpuesta)
# plt.title("3. Superposición (Validación)")
# plt.axis("off")
...
# # ── Etiquetado interactivo (pasos 1 y 2) ───────────────────────
# datos = etiquetar_regiones_carpeta(
#     carpeta        = r"GAYM_25_07_25-20251219T121604Z-1-001 1/GAYM_25_07_25/images1",
#     archivo_salida = "etiquetas_regiones.pkl",
#     fc_2           = 150,
#     min_area       = 80,
# )

# # ── Pasos 3-5: construir dataset ────────────────────────────────
# ds = preparar_dataset_segunda_red(
#     datos    = datos,
#     carpeta  = r"GAYM_25_07_25-20251219T121604Z-1-001 1/GAYM_25_07_25/images1",
#     val_frac = 0.25,
#     seed     = 0,
...
# # Nombres iguales al pipeline original
# Xtr2, ytr2     = ds["Xtr"],  ds["ytr"]
# Xval2, yval2   = ds["Xval"], ds["yval"]
# mu_obj         = ds["mu_obj"]
# sigma_obj      = ds["sigma_obj"]

# # ── Paso 6: inicializar prototipos ──────────────────────────────
# W2_init, w2_2_init = init_prototypes_from_samples(
#     Xtr2, ytr2, total=20, seed=0, noise_frac=0.05
# )

# # ── Paso 7: entrenar segunda red ────────────────────────────────
# resultado_obj = train_hybrid_lvq_segmentacion(
#     Xtr2, ytr2, Xval2, yval2,
#     W_init=W2_init, w2_init=w2_2_init,
#     epocas=250, alpha0=0.02, alpha_min=0.0005,
#     alphaerror=0.30, n_media_max=5,
#     patience=80, verbose_every=25,
#     guardar_cada=5, seed_np=0, seed_py=0
# )
# # 8) Guardar segunda red
# modelo_hlvq_objetos = {
#     "nombre_modelo": "HLVQ_objetos_ameba_no_ameba",
#     "features": ["circularidad", "solidez", "fft_ratio"],
#     "clases": {
#         0: "no_ameba",
#         1: "ameba"
#     },
#     "mu": mu_obj.astype(np.float32),
#     "sigma": sigma_obj.astype(np.float32),
#     "W_best": resultado_obj["W_best"].astype(np.float32),
#     "w2": resultado_obj["w2"].astype(np.int32),
# }

# with open("modelo_hlvq_objetos.pkl", "wb") as f:
#     pickle.dump(modelo_hlvq_objetos, f)

# print("Segunda red guardada en modelo_hlvq_objetos.pkl")
...
#     datos = pickle.load(f)
#
# print(f"Etiquetas cargadas desde: {ruta_etiquetas}")
# print(f"Imágenes con datos: {len(datos)}")
#
# # =========================================================
# # 2. Reconstruir dataset para la segunda red
# # =========================================================
# ds = preparar_dataset_segunda_red(
#     datos=datos,
#     carpeta=r"GAYM_25_07_25-20251219T121604Z-1-001 1/GAYM_25_07_25/images1",
...
#
# print("Shapes:")
# print("Xtr2:", Xtr2.shape, "ytr2:", ytr2.shape)
# print("Xval2:", Xval2.shape, "yval2:", yval2.shape)
#
#
# # =========================================================
# # 3. Inicializar prototipos
# # =========================================================
# W2_init, w2_2_init = init_prototypes_from_samples(
#     Xtr2, ytr2, total=9 * 15, seed=0, noise_frac=0.05
# )
#
# print("Prototipos iniciales:", W2_init.shape)
# print("Clases prototipos:", w2_2_init.shape)
#
#
# # =========================================================
# # 4. Entrenar segunda red HLVQ
# # =========================================================
# resultado_obj = train_hybrid_lvq_segmentacion(
#     Xtr2,
#     ytr2,
...
# }
#
# with open("modelo_hlvq_SOMIB.pkl", "wb") as f:
#     pickle.dump(modelo_hlvq_objetos, f)
#
# print("Segunda red guardada en modelo_hlvq_SOMIB.pkl")
